...
\begin{tikzpicture} [scale=1, auto=left]
  ...
  \node[circle,draw] (n7)     at (2.5,3) {5};
  \node[circle,draw] (n9)     at (6,3)    {4};
  \node[circle,draw] (n7a)   at (2.5,2) {3};
  \node[circle,draw] (n95)   at (6,2)    {4};
  \node[circle,draw] (n7a0) at (1,1)    {3};
  \node(n7a3) at (2,1)    {?};
  \node[circle,draw] (n7ab) at (3,1)    {1};
  \node[circle,draw] (n7af)  at (4,1)    {3};
  \node[circle,draw] (n958) at (5.2,1) {4};
  \node[circle,draw] (n959) at (6.8,1) {2};
...
\begin{tikzpicture} [scale=1,auto=left]
  ...
  \node[circle,draw] (n)       at (4.2,4) {6};
  \node[circle,draw] (n7)     at (2.5,3) {6};
  \node[circle,draw] (n9)     at (6,3)    {4};
  \node[circle,draw] (n7a)   at (2.5,2) {6};
  \node[circle,draw] (n95)   at (6,2)    {4};
  \node[circle,draw] (n7a0) at (1,1)    {3};
  \node[circle,draw] (n7a3) at (2,1)    {6};
  \node[circle,draw] (n7ab) at (3,1)    {1};
  \node[circle,draw] (n7af)  at (4,1)    {3};
  \node[circle,draw] (n958) at (5.2,1) {4};
  \node[circle,draw] (n959) at (6.8,1) {2};
...
Out of the 3 nodes along the path ($<>$, $<$7$>$, $<$7a$>$) only 2 ($<>$, $<$7$>$) have the same block number,
so the leecher sets $\texttt{fromLevel}  = 2$.
Imagine that the seeder replies with data as of a newer block \#6.
